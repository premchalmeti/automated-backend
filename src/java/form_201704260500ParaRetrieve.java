...
public class form_201704260500ParaRetrieve extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        try {
            ...
            pw = res.getWriter();
            iquery = "insert into form_201704260500( txt1,txt2) values ( '" + req.getParameter("txt1") + "','" + req.getParameter("txt2") + "')";
